...
public class Http2MultiplexCodec extends Http2FrameCodec {
    ...
    private static final ClosedChannelException CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), DefaultHttp2StreamChannel.class, "write(...)");
    /**
        ...
        private final class Http2ChannelUnsafe implements Unsafe {
            ...
            public void register(EventLoop eventLoop, ChannelPromise promise) {
                if (eventLoop != parent().eventLoop()) {
                    promise.setFailure(new IllegalArgumentException(
                            "EventLoop must be the same as parent.eventLoop()"));
                    return;
                }
                if (registered) {
            ...
            public void close(ChannelPromise promise) {
                ...
                try {
                    ...
                    // Only ever send a reset frame if the connection is still alove as otherwise it makes no sense at
                    // all anyway.
            ...
            public void beginRead() {
                ...
                do {
                    ...
                    if (m == CLOSE_MESSAGE) {
                        ...
                        DefaultHttp2StreamChannel.this.close();
                        return;
                    }
